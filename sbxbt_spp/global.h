...
#define	SPP_MASTER			0								//0:SLAVE 1:MASTER
#define	TARGET_ADDR			{0x00,0x15,0x83,0x3d,0x0a,0x57}	//MASTERの場合の接続先アドレス
...
#define BOARD_SBDBTS        0

// Define the baud rate constants UART1
#define	UARTPARAM1			UARTPARAM_N81			//data=8bit parity=none stopbit=1bit

#define BAUDRATE1       	9600					//デフォルトビットレート
#define	USE_RFCOMM_BAUDRATE	1						//0:baud rate as fixed 1:baud rate as RFCOMM parameter from Master
#define BRG_DIV1        	4
#define BRGH1           	1
...
#define BAUDRATE2       	115200					//DEBUG出力ビットレート
#define BRG_DIV2        	4
#define BRGH2           	1
...
// Configure LED2 - put on pin 15 (RB14)
#define	led2_setup()		(TRISBbits.TRISB14=0)
#define	led2_on()			(LATBbits.LATB14=0)	//ON
#define	led2_off()			(LATBbits.LATB14=1)	//OFF

// Configure U1RX - put on pin 13 (RP7)
#define	u1rx_setup()		(RPINR18bits.U1RXR = 7)
// Configure U1TX - put on pin 4 (RP3)
#define u1tx_setup()		(RPOR1bits.RP3R = 3)
// Configure U1CTS - put on pin 14 (RP8)
#define	u1cts_setup()		(RPINR18bits.U1CTSR = 8)
// Configure U1RTS - put on pin 8 (RB4)
// U1RTS has software control
#define	u1rts_setup()		(TRISBbits.TRISB4=0)
#define	u1rts_on()			(LATBbits.LATB4=0)	//ON:rx ready
#define	u1rts_off()			(LATBbits.LATB4=1)	//OFF:rx not ready

#if	STO_SERIAL
// Configure console OUT(U2TX) - put on pin 3 (RP2)
#define	sto_setup()			(RPOR1bits.RP2R = 5)
#define	sto_l()
#define	sto_h()
#else
// Configure Status OUT - put on pin 3 (RB2)
#define	sto_setup()		(TRISBbits.TRISB2=0)
#define	sto_l()			(LATBbits.LATB2=0)
#define	sto_h()			(LATBbits.LATB2=1)
#endif
