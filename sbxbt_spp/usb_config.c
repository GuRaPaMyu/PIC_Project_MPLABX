...
USB_TPL usbTPL[] =
{
    { INIT_CL_SC_P( 0xe0ul, 0x01ul, 0x01ul ), 0, 0, {TPL_CLASS_DRV} }, // Generic Bluetooth Adapter
    { INIT_CL_SC_P( 0xfful, 0x01ul, 0x01ul ), 0, 0, {TPL_CLASS_DRV} }, // Broadcom Corp. BCM20702A0
};
